...
public class ModBiomeModifiers {
    public static final DeferredRegister<Codec<? extends BiomeModifier>> BIOME_MODIFIERS =
            DeferredRegister.create(NeoForgeRegistries.Keys.BIOME_MODIFIER_SERIALIZERS, OnlyFlax.MOD_ID);

    public static final DeferredHolder<Codec<? extends BiomeModifier>, Codec<WildFlaxBiomeModifier>> WILD_FLAX_BIOME_MODIFIER =
